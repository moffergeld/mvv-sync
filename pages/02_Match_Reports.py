...
COL_RUN = "total_distance_zone_4"
COL_SPR = "total_distance_zone_5"
...
def build_phase_df(df_events: pd.DataFrame, phase: str) -> pd.DataFrame:
    ...
    g = dff.groupby(COL_PLAYER, as_index=False).agg(
        ...
        total_distance_zone_4=(COL_RUN, "sum"),
    ...
    g["run_per_min"] = g["total_distance_zone_4"] / dur_min
    g["spr_per_min"] = g["total_distance_zone_5"] / dur_min
    g["hspr_per_min"] = g["total_distance_zone_6"] / dur_min
