          ...
          <div class="team-hero">
            <div class="team-hero-inner">
              ...
              <div class="team-pill-row">
                ...
                <span class="team-pill">ACWR {acwr_meta['short_label']} week {current_week_label} op TD, total_distance_zone_4, total_distance_zone_5 en high total_distance_zone_5</span>
              </div>
            </div>
          </div>
